...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'vvusu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'a software engineer 🐵', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.vvusu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '科技,生活,技术,博客', // 网站关键词 英文逗号隔开
